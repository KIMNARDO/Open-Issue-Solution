...
const NavCollapse = ({ menu, level, parentId, setSelectedItems, selectedItems, setSelectedLevel, selectedLevel }: Props) => {
  ...
  const Icon = <FontAwesomeIcon icon={menu.icon!} />; //menu.icon!;
  const menuIcon = menu.icon ? Icon : borderIcon; //<Icon style={{ fontSize: drawerOpen ? '1rem' : '1.25rem' }} /> : borderIcon;
      ...
      {menuOrientation === MenuOrientation.VERTICAL || downLG ? (
        <>
            ...
            sx={{
              ...
              ...(drawerOpen && {
                ...
                '&.Mui-selected': {
                  ...
                  '&:hover': { color: iconSelectedColor, bgcolor: theme.palette.mode === ThemeMode.DARK ? 'divider' : 'primary.lighter' }
                }
              }),
              ...(!drawerOpen && {
                '&:hover': {
          ...
          >
            ...
            {level === 1 && ( //(drawerOpen || (!drawerOpen && level !== 1))
              <ListItemText
                primary={
                  <Typography
                    variant="h6"
            ...
            {(drawerOpen || (!drawerOpen && level !== 1)) &&
              (menu?.url ? (
                ...
                >
                  {miniMenuOpened || open ? (
                    <FontAwesomeIcon icon={faAngleUp} color={theme.palette.grey[500]} /> //<UpOutlined style={{ fontSize: '0.625rem', color: theme.palette.primary.main }} />
                  ) : (
                    <FontAwesomeIcon icon={faAngleDown} color={theme.palette.grey[500]} /> //<DownOutlined style={{ fontSize: '0.625rem' }} />
                  )}
                </IconButton>
              ) : (
                <>
                  {miniMenuOpened || open ? (
                    <FontAwesomeIcon icon={faAngleUp} color={theme.palette.grey[500]} /> //<UpOutlined style={{ fontSize: '0.625rem', marginLeft: 1, color: theme.palette.primary.main }} />
                  ) : (
                    <FontAwesomeIcon icon={faAngleDown} color={theme.palette.grey[500]} /> //<DownOutlined style={{ fontSize: '0.625rem', marginLeft: 1 }} />
                  )}
                </>
              ))}
        ...
        <>
          ...
          >
            <Box onClick={handlerIconLink} sx={FlexBox}>
              ...
              {!menuIcon && level !== 1 && (
                <ListItemIcon sx={{ my: 'auto', bgcolor: 'primary.lighter', '&:hover': { bgcolor: 'primary.lighter' } }}>
              ...
              <ListItemText
                primary={
                  <Typography
                    variant="body1"
                    color="inherit"
                    sx={{ my: 'auto', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}
                  >
                    {menu.title}
                  </Typography>
                }
