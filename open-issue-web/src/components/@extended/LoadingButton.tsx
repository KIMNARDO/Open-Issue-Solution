...
// types
import { ExtendedStyleProps, IconButtonShapeProps } from 'types/extended';
...
const LoadingButtonStyle = styled(MuiLoadingButton, { shouldForwardProp: (prop) => prop !== 'shape' && prop !== 'variant' })(
  ({ theme, variant, shape, color, loading, loadingPosition }: StyleProps) => ({
    ...
    ...(variant === 'outlined' && {
      ...
      '&::after': {
        boxShadow: `0 0 6px 6px ${theme.palette.grey[400]}`
      },
      '&:active::after': {
        boxShadow: `0 0 0 0 ${theme.palette.grey[400]}`
      },
      '&:focus-visible': {
